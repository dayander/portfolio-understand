...
function handleRender2(req, res){
    console.log("blog post handler");





    axios.get(`http://localhost:4001/posts/${req.params.name}`)
        .then(function(response){
            ...
            if (context.url) {
                ...
                console.log("this is the error spot");
